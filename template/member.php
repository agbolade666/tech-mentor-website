					...
					<form method="POST" action="member_login_process.php">
						<table width="79%" border="0">
							<tbody><tr>
								...
								<td width="313">
								<font size="2" face="Arial">&nbsp;<input name="account" size="20" class="fields" value="username" type="text"required /></font></td>
							</tr>
							<tr>
								<td><font size="2" face="Arial">Password:</font></td>
								<td width="313">
								<font size="2" face="Arial">&nbsp;<input name="pin" size="20" class="fields" type="password" required /></font></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td width="313">
