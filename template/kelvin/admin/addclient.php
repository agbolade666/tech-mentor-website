...
<HTML><HEAD><TITLE>Add Client</TITLE>
...
<!--
.textMB {
	FONT-WEIGHT: bold; FONT-SIZE: 12px; FONT-FAMILY: Arial, Helvetica, sans-serif; HEIGHT: 25px
}
FORM {
	MARGIN: 0px
}
...
marginwidth="0" enctype="multipart/form-data" >
<div align="center">
