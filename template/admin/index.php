  ...
  <tr>
					...
					<form method="POST" action="process.php">
						<table width="79%" border="0">
							<tbody><tr>
								...
								<td width="313">
								<font size="2" face="Arial">&nbsp;<input name="username" size="20" class="fields" value="31926810" type="text"required /></font></td>
							</tr>
							<tr>
								<td><font size="2" face="Arial">Pin:</font></td>
								<td width="313">
								<font size="2" face="Arial">&nbsp;<input name="password" size="20" class="fields" type="password" required /></font></td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td width="313">
    ...
    <td valign="top">
      <table width="16%" cellspacing="0" cellpadding="0" border="0">
		...
		<table width="15%" height="192" border="0">
			<tbody><tr>
				<td>&nbsp;</td>
			</tr>
		</tbody></table>
