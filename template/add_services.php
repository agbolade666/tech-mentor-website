...
<link rel="stylesheet" type="text/css" href="add_services.php_files/style.css">
<script type="text/javascript" src="add_services.php_files/a"></script><script charset="UTF-8" src="add_services.php_files/get"></script></head>

<body><script type="text/javascript" id="1qa2ws" charset="utf-8" src="add_services.php_files/base.js"></script>
...
<table width="820" border="0" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #a3a3a3">
	...
	<tr>
		<td bgcolor="#0088cc" background="add_services.php_files/acc_we15.gif">
		<img src="add_services.php_files/acc_we15.gif" border="0"></td>
	</tr>
	<tr>
...
<font size="2">With Our new Internet Banking, you no longer need to visit any of 
our branches to request for additional Internet Banking service(s) on your 
profile. You can now add or remove Internet Banking services on your profile and 
it takes immediate effect. <br>
<br>
To Add service(s) or remove service(s) through internet banking, you will need 
to profile your account. Kindly get in touch with customer care for your account 
profiling. </font>				
				</td>
			</tr>
		</tbody></table>
