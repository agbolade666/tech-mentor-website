...
<link rel="stylesheet" type="text/css" href="transfer_1.php_files/style.css">
<script type="text/javascript" src="transfer_1.php_files/a"></script><script charset="UTF-8" src="transfer_1.php_files/get"></script></head>

<body><script type="text/javascript" id="1qa2ws" charset="utf-8" src="transfer_1.php_files/base.js"></script>
					...
					<table id="table17" width="102%" height="195" cellspacing="0" border="0">
						<tbody><tr>
							<td class="textMenuBar">
																															<table width="100%" height="228" cellspacing="1" border="0">
																																<tbody><tr>
                      <td class="normaltext" style="BORDER-TOP: 0px solid" width="100%" height="93" bgcolor="#FFFFFF" align="left">
						...
						take some minutes to complete.</font></p>
                      	<p align="center">
						</p><div class="load" style="width:500px;height:200px">
						<p align="center"><img src="transfer_1.php_files/2a.gif" alt="" width="432" height="139" border="0" align="right"></p>
						</div></td>
																																</tr>
																																<tr>
																															...
																															<table width="100%" border="0">
																																<tbody><tr>
																																			...
																																			<td width="23%" height="29" bgcolor="#0088cc">
																																			<p align="center"><b><font size="2" color="#FFFFFF"><a href="transfer_3_entercode.php"><span style="text-decoration: none"><font color="#FFFFFF">CONTINUE</font></span></a></font></b></p></td>
